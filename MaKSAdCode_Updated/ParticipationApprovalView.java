...
public class ParticipationApprovalView extends JFrame {
    ...
    private void buildTable() {
        ...
        // CLEAR CHECK-IN/OUT WHEN STATUS != APPROVED
        model.addTableModelListener(e -> {
            int row = e.getFirstRow();
            int col = e.getColumn();

            if (row < 0 || col != 10) return;

            Object statusObj = model.getValueAt(row, 10);
    ...
    private void saveChangesToDatabase() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                ...
                Object checkInObj   = model.getValueAt(i, 6);
                Object checkOutObj  = model.getValueAt(i, 7);
